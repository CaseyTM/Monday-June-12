...
*************************************************************************************
console.log(y) on line 20 will print an error because y has not yet been defined or declared outside of the scopeThis function;
console.log(x) on line 24 will print the global definition of x (assuming the error from console.log(y) has been resolved;);
...
**************************************************************************************/
x will print undefined, it's delcaration has been hoisted but is not defined until line 53;
there is no console.log(Y);
console.log(foo()); will print the string "function hoisting";
...
**************************************************************************************/
the first will print 4;
the second will print an error, add only exists within the IIFE
...
(function() {
  ...
  var accountCheck = function() {
    ...
    function accountStat() {
      ...
      var months;
      if (goodStanding == true && monthsActive >= 11) {
